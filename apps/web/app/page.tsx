...
export default function Home() {
  return (
    <main className="flex min-h-0 flex-1 flex-col overflow-x-hidden bg-background">
      ...
      <section className="relative flex flex-1 items-center">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl gap-8 px-5 py-9 sm:gap-12 sm:px-8 sm:py-24 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] lg:items-center">
          <div className="space-y-5 sm:space-y-7">
            <div className="text-sm font-medium text-[#4f7da7]">One editor. Your publications.</div>
            <div className="space-y-5">
              <h1 className="max-w-3xl text-[2rem] leading-[1.08] font-semibold tracking-tight sm:text-6xl">
            ...
            <div className="flex flex-col gap-2 min-[380px]:flex-row min-[380px]:flex-wrap sm:gap-3">
              <Button asChild size="lg" className="w-full min-[380px]:w-auto">
                <Link href="/login">Continue with AT Protocol <ArrowRightIcon data-icon="inline-end" /></Link>
              </Button>
              <Button asChild size="lg" variant="ghost" className="w-full min-[380px]:w-auto">
