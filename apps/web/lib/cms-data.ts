...
export const seedAccounts: LinkedAccount[] = [
  {
    ...
    scope:
      "atproto transition:generic include:site.standard.authFull include:community.lexicon.calendar.authFull",
...
export const seedPublications: Publication[] = [
  {
    ...
    themeType: "pub.leaflet.theme.publication",
  ...
  },
  {
    ...
    themeType: "pub.offprint.theme.publication",
  ...
  },
  {
    ...
    themeType: "app.pckt.theme.publication",
    themeName: "pckt desk",
    host: "pckt",
    syncedAt: "2026-07-08T16:00:00.000Z",
  },
